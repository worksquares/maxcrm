...
(
    ...
    created_by UUID,
    updated_by UUID,
    CONSTRAINT fk_price_entries_company FOREIGN KEY (company_id) REFERENCES public.companies(company_id) ON DELETE RESTRICT,
    CONSTRAINT fk_price_entries_price_book FOREIGN KEY (price_book_uuid) REFERENCES public.price_books(price_book_uuid) ON DELETE CASCADE,
    CONSTRAINT fk_price_entries_product FOREIGN KEY (product_uuid) REFERENCES public.products(product_uuid) ON DELETE CASCADE,
